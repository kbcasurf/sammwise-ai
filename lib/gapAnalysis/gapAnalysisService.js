...
// extraBody is spread FIRST in both request builders below, so that a misconfigured
// AI_PROVIDER_EXTRA_BODY can never clobber the required model/max_tokens/messages
// (or system, for Anthropic) fields that come after it in the object literal.
...
const gapAnalysisService = { analyzeAnswers, extractJson, normalizeReport, sanitizeText };
